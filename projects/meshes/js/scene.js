...
Scene.setupMaterials = function() {
    var default_mat = new THREE.MeshLambertMaterial( { color : 0x85bb6a, side : THREE.DoubleSide, vertexColors: THREE.NoColors  } );
    ...
    var sel_mat = new THREE.MeshLambertMaterial( { color : 0x4a27ed, side : THREE.DoubleSide, vertexColors: THREE.NoColors  } );
...
Scene.showVertexColors = function () {
    this._materials[0].vertexColors = THREE.VertexColors;
    this._materials[0].needsUpdate = true;
};

Scene.hideVertexColors = function (){
    this._materials[0].vertexColors = THREE.NoColors;
    this._materials[0].needsUpdate = true;
};
